execute if entity @s[tag=slf.skill.rechette_step] run tellraw @s {"text":"You already know this skill!","color":"red"}
execute if entity @s[tag=slf.skill.rechette_step] run return fail
execute if score @s slf.focus matches 26 run tellraw @s {"text":"Already focusing this skill.","color":"yellow"}
execute if score @s slf.focus matches 26 run return fail
