execute if entity @s[tag=slf.skill.manbufu] run tellraw @s {"text":"You already know this skill!","color":"red"}
execute if entity @s[tag=slf.skill.manbufu] run return fail
execute if score @s slf.focus matches 4 run tellraw @s {"text":"Already focusing this skill.","color":"yellow"}
execute if score @s slf.focus matches 4 run return fail
