execute if entity @s[tag=slf.skill.strong_puncher] run tellraw @s {"text":"You already know this skill!","color":"red"}
...
execute if score @s slf.focus matches 22 run tellraw @s {"text":"Already focusing this skill.","color":"yellow"}
execute if score @s slf.focus matches 22 run return fail
