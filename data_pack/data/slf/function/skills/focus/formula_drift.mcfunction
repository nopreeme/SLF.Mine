execute if entity @s[tag=slf.skill.formula_drift] run tellraw @s {"text":"You already know this skill!","color":"red"}
...
execute if score @s slf.focus matches 24 run tellraw @s {"text":"Already focusing this skill.","color":"yellow"}
execute if score @s slf.focus matches 24 run return fail
