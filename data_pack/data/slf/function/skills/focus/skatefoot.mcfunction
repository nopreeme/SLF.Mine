execute if entity @s[tag=slf.skill.skatefoot] run tellraw @s {"text":"You already know this skill!","color":"red"}
...
execute if score @s slf.focus matches 32 run tellraw @s {"text":"Already focusing this skill.","color":"yellow"}
execute if score @s slf.focus matches 32 run return fail
