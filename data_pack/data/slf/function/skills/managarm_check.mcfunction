...
execute if score @s slf.hp >= 7 if score @s slf.hp matches ..13 run effect give @s minecraft:strength 3 1 true
execute if score @s slf.hp >= 14       run effect give @s minecraft:strength 3 0 true
