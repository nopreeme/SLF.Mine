...
execute unless score @s slf.bt_kills matches 50.. run tellraw @s {"text":"Not yet. Prove yourself with Big Tantrum first.","color":"red"}
execute unless score @s slf.bt_kills matches 50.. run return fail
