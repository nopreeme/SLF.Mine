...
execute if score @s slf.move_delta >= 500                                            run effect give @s minecraft:haste 3 1 true
execute if score @s slf.move_delta >= 200 if score @s slf.move_delta matches ..499  run effect give @s minecraft:haste 3 0 true
