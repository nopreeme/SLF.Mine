...
execute if score @s slf.knight_trials matches 3.. run return fail
...
execute if score @s slf.knight_trials matches 3.. run tellraw @s {"text":"All trials complete. Your alignment awaits.","color":"gold","bold":true}
