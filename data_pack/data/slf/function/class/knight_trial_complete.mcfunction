...
execute if entity @s[scores={slf.knight_trials=3..}] run return fail
...
execute if entity @s[scores={slf.knight_trials=3..}] run tellraw @s {"text":"All trials complete. Your alignment awaits.","color":"gold","bold":true}
